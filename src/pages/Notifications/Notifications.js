            ...
            isAll ? (
              <>
                <FollowedYou
                  followingUser={{
                    userImage:
                      "https://dotesports.com/valorant/news/sentinels-reportedly-acquires-tenz-in-7-figure-buyout-from-cloud9",
                    displayName: "SEN TenZ",
                  }}
                />
                <LikedYou
                  likePost={{
                ...
                <Post
                  ...
                  userimage="https://dotesports.com/valorant/news/sentinels-reportedly-acquires-tenz-in-7-figure-buyout-from-cloud9"
                  displayName="SEN Tenz"
                  text="Watch @adityaa.aks 's Chamber, He's just insane"
                  date="1614077764184"
                />
              </>
            ) : (
